...
$("document").ready(function () {
    $("#prueba").dragAndDrop({
        ...
        drags: {
            1: {
                contenido: "img/concepto_uno.png"
            },
            2: {
                contenido: "img/concepto_dos.png"
            },
            3: {
                contenido: "img/concepto_tres.png"
            },
            4: {
                contenido: "img/concepto_cuatro.png"
            },
            5: {
                contenido: "img/concepto_cinco.png"
            },
            6: {
                contenido: "img/concepto_seis.png"
            },
            7: {
                contenido: "img/concepto_siete.png"
            }
        },
        drops: {
            1: {
