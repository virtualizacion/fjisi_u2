...
$("document").ready(function () {
    $("#prueba").dragAndDrop({
        ...
        drags: {
            1: {
                contenido: "../images/cont03/reto03/opcion01.png"
            },
            2: {
                contenido: "../images/cont03/reto03/opcion02.png"
            },
            3: {
                contenido: "../images/cont03/reto03/opcion03.png"
            },
            4: {
                contenido: "../images/cont03/reto03/opcion04.png"
            },
            5: {
                contenido: "../images/cont03/reto03/opcion05.png"
            },
            6: {
                contenido: "../images/cont03/reto03/opcion06.png"
            }
        },
        drops: {
            1: {
